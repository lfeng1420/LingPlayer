...
- **Les traductions du programme principal et des plugins doivent être synchronisées** — si vous modifiez la traduction d'une Key dans Main, vérifiez si le même changement est nécessaire dans Plugins
