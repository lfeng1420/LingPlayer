...
- **Переводы основной программы и плагинов должны быть синхронизированы** — если вы изменили перевод Key в Main, проверьте, требуется ли такое же изменение в Plugins
